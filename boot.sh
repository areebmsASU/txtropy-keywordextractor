...
sudo chown -R ubuntu keywordextractor.git/
sudo chown -R ubuntu keywordextractor/
...
timeout 55m python manage.py load_chunks && python manage.py get_spacy_tokens
